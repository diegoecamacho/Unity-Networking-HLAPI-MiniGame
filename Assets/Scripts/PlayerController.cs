...
public class PlayerController : NetworkBehaviour {
    ...
    public override void OnStartClient()
    {
        ...
        m_client.RegisterHandlerSafe((short)GameMessageID.TransformPacket, OnTransformReceived);
        Debug.Log("Client Start" + netId);
    }
    ...
    public void SendPosition()
    {
        ...
        {
            sendResult = m_client.Send((short)GameMessageID.TransformPacket, msg);
        }
    ...
    void OnTransformReceived(NetworkMessage netMsg)
    {
        ...
        Debug.Log("On Transform" + netId);
        Debug.Log("On Msg" + msg.m_netId);
